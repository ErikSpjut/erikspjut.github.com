...
* Custom PC boards for high power and model rocketry
  * 12-DOF [Inertial Measurement Unit](https://dofpro.org/RCK/const/vulcanTest#testing-the-teensy-data-logger) 
  * Earlier Analog Inertial Measurement Units, [IMU2, 3, & 4](https://pages.hmc.edu/spjut/NewE80/AccelGyroLab.html)
...
* Video production (scripting, filming, scoring, editing, and post-production)
  * [DOFPro](dofpro.qmd) has a set of almost [100 videos](https://www.youtube.com/playlist?list=PLf9RV6P-qIdDY3hgaCRIyv5ntljNfyENk) on [Chemical and Thermal Processes](https://dofpro.org/CTP/).
  * I co-wrote, directed, videoed, edited, wrote and recorded the scores for the following videos:
	...
	* I used some of my footage and a lot of other people's footage to put together the following videos:
		...
		* [Launch Video 1 2016](https://youtu.be/PbU-tN4-T0Q)
		* [Launch Video 2 2016](https://youtu.be/N07a_9KIgEM)
...
* Audio production and podcasting (songwriting and composing, recording, editing, and post-production)
	...
	* I've written, recorded and produced two different full-length albums.
		* [East High Anthology](https://soundcloud.com/heerret/sets/east-high-anthology). [Lyrics and Notes](/easthighanth.qmd) The songs were about the trauma and joy of my high-school days
...
* Development of [digital filters](https://csound.com/docs/manual/clfilt.html) for CSound
